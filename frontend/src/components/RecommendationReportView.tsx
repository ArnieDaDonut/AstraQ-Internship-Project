...
import { 
  Printer, Download, ShieldCheck, FileText, BookOpen, AlertTriangle, 
  Layers, CheckCircle, ArrowRight, Share2, Award, Calendar, Hash 
} from 'lucide-react';
    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="no-print bg-white/70 dark:bg-white/[0.03] border border-[#121212]/10 dark:border-white/10 p-4 rounded-none flex flex-wrap items-center justify-between gap-4 backdrop-blur-md sticky top-4 z-20 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 px-5 py-2.5 bg-[#121212] text-white dark:bg-white dark:text-[#121212] font-bold text-xs uppercase tracking-widest hover:opacity-90 transition-opacity cursor-pointer shadow-sm"
          >
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-[10px] font-mono font-bold uppercase">
                    ...
                    <span className={`px-2 py-0.5 ${
                      item.severity === 'High' ? 'bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20' :
