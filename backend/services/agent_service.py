...
def generate_final_report(question: str, research_type: str, preferences: str) -> dict:
    """
    ...
    full_prompt = (
        ...
        "DIRECTIVES:\n"
        "1. Produce highly detailed, comprehensive, academic-grade prose for every section. Do NOT write short 1-sentence summaries. Provide thorough analytical depth.\n"
        ...
        "4. Strictly format the output to match the requested JSON schema."
    )
